...
const SecaoTexto = () => {
    return (
        <div className="bg-lime-400 rounded-4xl p-4 m-8 grid md:grid-cols-2 items-center">
            <div className="p-4">
            ...
            <div className='flex justify-center'>
                <img src={foto1} className='md:max-h-100 rounded-4xl' alt="Beach tennis training" />
            </div>
        </div>
